  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-b from-[#020d1f] via-black to-[#020d1f] text-white text-center px-4 relative">
      <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm border border-blue-200/30 rounded-full px-6 py-2 mb-8 mt-12 hover:scale-110 transition-all duration-300 hover:shadow-xl shadow-md">
          <span className="text-blue-200 text-sm">✨ The Future of AI is Here</span>
        </div>
      ...
      <p className="text-xl md:text-3xl text-gray-200 font-light">and creative ideas. Powered by modern AI technology.</p>
      <p className="text-lg md:text-xl text-gray-300 leading-relaxed font-light mt-2">Powered by intelligence that actually understands you and your vision.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-3 gap-10 mt-10 text-gray-600 ">
        <div className="bg-[#020d1f] p-8 max-w-64 rounded-lg shadow-xl hover:scale-105 transition-all duration-300 hover:shadow-xl">
          ...
          <h1 className="text-lg font-semibold text-slate-200">Lightning Fast</h1>
          <p className='text-slate-400'>Get instant results with our optimized AI engine designed for speed and efficiency that never compromises quality.</p>
        </div>
        <div className="bg-[#020d1f] p-8 max-w-64 rounded-lg shadow-xl hover:scale-105 transition-all duration-300 hover:shadow-xl">
          ...
          <h1 className="text-lg font-semibold text-slate-200">Truly Intelligent</h1>
          <p className='text-slate-400'>Advanced reasoning capabilities that go beyond simple pattern matching to understand context and nuance.</p>
        </div>
        <div className="bg-[#020d1f] p-8 max-w-64 rounded-lg shadow-xl hover:scale-105 transition-all duration-300 hover:shadow-xl">
          ...
          <h1 className="text-lg font-semibold text-slate-200">Privacy First</h1>
          <p className='text-slate-400'>Your data stays yours. Built with privacy and security as core principles from day one.</p>
        </div>
      </div>

      <div className="flex flex-col items-center mt-10 text-gray-600">
        <h1 className="text-xl font-semibold text-slate-500">Powered by</h1>
        <img
