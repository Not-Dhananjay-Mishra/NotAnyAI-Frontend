...
export const TempCode = () => {
  ...
  return (
    <>
      ...
      {page === "main" && (
      <div className='bg-[#161616] min-h-screen flex-col text-white'
      ...
      >
        ...
        <div className='flex flex-col items-center'>
          <motion.h1 className='text-5xl md:text-7xl lg:text-8xl font-instrument font-bold bg-white bg-clip-text text-transparent drop-shadow-lg pt-10'
          ...
          <motion.p className='text-lg mt-3 max-w-lg text-center'
            ...
            animate={{ opacity: 1, filter: "blur(0px)" }}
            transition={{ duration: 0.3 }}
          >Build websites in minutes using <span className='text-2xl text-blue-500 instrument-serif-regular-italic'>Artificial intelligence </span>
            Just describe your idea and watch it come alive.</motion.p>
        </div>
        <motion.div className='flex flex-col items-center mt-16 gap-4 bg-[#111111] px-4 py-4 max-w-2xl mx-auto rounded-3xl'
        >
          <motion.input type="text" name="prompt" id="prompt" className='w-full h-12 p-3 rounded-3xl text-white bg-[#252525] ' 
          ...
          <div className='flex justify-between items-center w-full'>
            <div className='flex gap-3 items-center justify-end'>
              <input type="submit" className=' bg-white px-6 py-3 rounded-3xl text-black font-semibold  hover:bg-gray-200 transition-all duration-300'
              ...
              <input type="file" id="fileInput"
                ...
                className="w-10 h-10 hidden items-center justify-center rounded-full hover:bg-gray-200 cursor-pointer transition-colors" />
              <label
                htmlFor="fileInput"
        ...
        <div className='flex gap-8 p-6 mt-10 justify-center flex-wrap'>
          <div className='flex flex-col gap-2 max-w-xs text-center text-white bg-[#252525] p-6 rounded-3xl hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-gray-600'>
        ...
        <div className="bg-[#111111] py-12 px-6 mt-16 rounded-3xl max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-center text-white mb-8">❓ Frequently Asked Questions</h2>
          <div className="space-y-4">
            <details className="bg-[#252525] rounded-2xl p-4 hover:bg-[#222222] transition">
              <summary className="cursor-pointer text-md font-semibold text-white">
        ...
        <footer className="text-center text-slate-500 text-xs mt-20 pb-6">
          <div>
            <h1>© 2069 SiteCraft AI A Product of NotAnyAI</h1>
